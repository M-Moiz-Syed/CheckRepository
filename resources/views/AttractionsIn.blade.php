...
@section("content")
    ...
    <div class="container">
        <div class="category-heading-content category-heading-content__2 text-uppercase">
            ...
            <!-- BREADCRUMB -->
            <div class="find">
                <h2 class="text-center">Find Your Attraction</h2>
                <form>
                    <div class="form-group">
                        ...
                        <div class="form-actions">
                            <input type="submit" value="Find My Attraction">
                        </div>
                    </div>
                </form>
            </div>
                    ...
                    <div class="filter-item-wrapper">
                        ...
                        <div class="attraction-item">
                            <div class="item__inner">
                                <div class="item-media">
                                    <div class="image-cover">
                                        <img src="images/attraction/2.jpg" alt="">
                                    </div>
                                </div>
                                <div class="item-body">
                                    <div class="item-title">
                        ...
                        <div class="attraction-item">
                            <div class="item__inner">
                                <div class="item-media">
                                    <div class="image-cover">
                                        <img src="images/attraction/3.jpg" alt="">
                                    </div>
                                </div>
                                <div class="item-body">
                                    <div class="item-title">
                        ...
                        <div class="attraction-item">
                            <div class="item__inner">
                                <div class="item-media">
                                    <div class="image-cover">
                                        <img src="images/attraction/5.jpg" alt="">
                                    </div>
                                </div>
                                <div class="item-body">
                                    <div class="item-title">
